    ...
    >
      ...
      <div className="flex-1 p-5 md:p-6 flex flex-col justify-center relative bg-white overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <ul className="space-y-2 mb-4">
            {description.map((point, index) => (
              <li key={index} className="flex items-start gap-2.5">
                ...
                <span className="text-slate-600 text-[13px] font-medium leading-[1.4]">
                  {point}
                </span>
              </li>
            ))}
          ...
          <Link
            href={href}
            className="inline-flex items-center text-[#005f99] font-bold text-[14px] hover:gap-2 transition-all"
          >
